...
export const projects: Project[] = [
  {
    ...
    githubUrl: 'https://github.com/xlightningstar/google-translate-scrambler',
    stack: ['Python', 'CLI', 'Google Translate'],
  },
  {
    name: 'Ieka v2',
    description: 'A Discord bot with LLM integration.',
    githubUrl: 'https://github.com/xlightningstar/ieka-v2',
    stack: ['Python', 'Discord', 'LLM'],
  },
  {
    name: 'Sudoku Solver',
    description: 'A Python program that can solve 9x9 Sudoku puzzles.',
    githubUrl: 'https://github.com/xlightningstar/sudoku-solver',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/xlightningstar/timely',
